...
_TextElementModel _$TextElementModelFromJson(Map<String, dynamic> json) => _TextElementModel(
...
Map<String, dynamic> _$TextElementModelToJson(_TextElementModel instance) => <String, dynamic>{
  'text': instance.text,
