...
_LinkElementModel _$LinkElementModelFromJson(Map<String, dynamic> json) => _LinkElementModel(
...
Map<String, dynamic> _$LinkElementModelToJson(_LinkElementModel instance) => <String, dynamic>{
  'text': instance.text,
