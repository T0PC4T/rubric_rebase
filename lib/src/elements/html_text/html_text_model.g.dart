...
_HtmlTextElementLementModel _$HtmlTextElementLementModelFromJson(
  Map<String, dynamic> json,
) => _HtmlTextElementLementModel(
  text: json['text'] as String,
  textAlign:
      $enumDecodeNullable(_$HtmlTextAlignEnumMap, json['textAlign']) ??
      HtmlTextAlign.left,
);

Map<String, dynamic> _$HtmlTextElementLementModelToJson(
  _HtmlTextElementLementModel instance,
) => <String, dynamic>{
  'text': instance.text,
