...
abstract class HtmlTextElementModel with _$HtmlTextElementModel {
  @JsonSerializable()
  const factory HtmlTextElementModel({
    required String text,
    @Default(HtmlTextAlign.left) HtmlTextAlign textAlign,
  }) = _HtmlTextElementLementModel;

  factory HtmlTextElementModel.fromJson(Map<String, dynamic> json) =>
      _$HtmlTextElementModelFromJson(json);
